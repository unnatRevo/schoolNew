				...
				<div class="login-box">
					...
					<form class="form-horizontal" action="/schoolNew/Controller/users/userLoginCon.php" method="post">
							<div class="input-prepend" title="Username">
								...
								<input class="input-large span10" name="username" id="username" type="text" required="true" placeholder="Username"/>
							</div>
							<div class="clearfix"></div>

							<div class="input-prepend" title="Password">
								<span class="add-on"><i class="halflings-icon lock"></i></span>
								<input class="input-large span10" name="password" id="password" type="password" required="true" placeholder="Password"/>
							</div>
							<div class="clearfix"></div>							

							<div class="button-login">
								<button type="submit" class="btn btn-primary">Login</button>
								<a href="/schoolNew/View/user/userSignUp.php" class="btn btn-link">Create User</a>
							</div>
							<div class="clearfix"></div>
					<hr>
					</form>
